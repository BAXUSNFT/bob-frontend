        ...
        return (
            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className="flex m-4 rounded-md w-full flex-col bg-bonk-white dark:bg-bonk-blue-dark text-bonk-orange shadow-xl group-data-[variant=floating]:rounded-md group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow duration-300 transition-all"
                    >
                        {children}
                    </div>
                </div>
...
>(({ className, asChild = false, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            className={cn(
                "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-bonk-orange outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
